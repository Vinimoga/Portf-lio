...
optmizer1 = torch.optim.SGD(params=Model_1.parameters(),lr=0.01,momentum=0.8)
...
anim = FuncAnimation(fig=fig,
                     func=update_plot,
                     frames=torch.arange(0, 50),
                     init_func = init_f,
                     interval=100)

print(Model_1.state_dict())
anim.save('Projetos/Matplotlib/Linear_Regression_With_AI/Linear_Regression_Momentum.mp4',
          dpi=150,
          fps=5,
          writer='ffmpeg')